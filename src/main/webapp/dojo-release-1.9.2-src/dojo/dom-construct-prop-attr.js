define(["./_base/kernel", "./sniff", "./_base/window", "./dom", "./_base/lang", "./dom-style", "./_base/connect", "exports"],
        function(dojo, has, win, dom, lang, style, conn, exports){
...
/* dom-construct */
    ...
    var create = exports.create = function create(/*DOMNode|String*/ tag, /*Object*/ attrs, /*DOMNode|String?*/ refNode, /*String?*/ pos){
        ...
        if(attrs){ exports.set(tag, attrs); }
    ...
    exports.set = function setProp(/*DOMNode|String*/ node, /*String|Object*/ name, /*String?*/ value){
        ...
        if(propName == "innerHTML"){
            ...
            if(has("ie") && node.tagName.toLowerCase() in {col: 1, colgroup: 1,
                ...
                exports.empty(node);
                node.appendChild(exports.toDom(value, node.ownerDocument));
            }else{
                node[propName] = value;
            }
            return node; // DomNode
